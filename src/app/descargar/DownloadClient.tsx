...
export default function DownloadClient() {
  ...
  const handleAndroidInstallClick = async () => {
    ...
    try {
      ...
      if (!accepted) {
        // Si el navegador no lanzó el prompt nativo directamente, scroll suave a los pasos
            ...
            <div className="flex items-center gap-3 pb-3 border-b border-border/60">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Solo toma 3 toques en Safari (sin descargas pesadas).
                </p>
              </div>
            </div>
          ...
          <div className="bg-card border border-border rounded-3xl p-6 sm:p-7 shadow-sm space-y-6">
            <div className="flex items-center gap-3 pb-3 border-b border-border/60">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Instalación inmediata a pantalla completa con soporte offline.
                </p>
              </div>
            </div>

            {/* Botón directo de instalación si está listo el prompt nativo */}

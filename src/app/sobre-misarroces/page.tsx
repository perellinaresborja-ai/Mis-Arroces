...
export default function SobreMisArroces() {
  return (
    <div className="min-h-screen bg-background flex flex-col pb-24 md:pb-8 pt-4 md:pt-12">
      <div className="w-full max-w-5xl mx-auto px-4 md:px-8 space-y-16">
        ...
        <header className="text-center space-y-6 pt-8">
          ...
          <div className="pt-6">
            <Link href="/login" className={buttonVariants({ size: "lg", className: "rounded-xl font-bold text-lg px-8 h-14" })}>

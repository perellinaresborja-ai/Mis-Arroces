...
export default async function PublicProfilePage({ 
  ...
  const avatarUrl = profile.avatar?.storage_path 
    ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/recipe_media/${profile.avatar.storage_path}`
    : null
  ...
  const coverUrl = profile.cover?.storage_path
    ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/recipe_media/${profile.cover.storage_path}`
    : null;
  return (
